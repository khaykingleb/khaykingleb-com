      ...
      <div className="grow">
        <div className="text font-eb-garamond-light mx-auto max-w-lg text-pretty text-center">
          ...
          <p className="mb-2">
            ...
            actually being one (yet! Who knows, maybe, Devin's gonna make it,
            lol).
          </p>
          <p className="mb-2">
            ...
            yourself. Also, if you know Russian, check out my Telegram channel
            in the footer below, it's where I share thoughts and materials in a
            more unstructured and freestyle format.
          </p>
        </div>
      </div>
      <Footer />
